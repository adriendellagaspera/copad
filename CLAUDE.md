...
| `markdownCodec` | `.md`, `.markdown` | CommonMark + GFM strikethrough (`~~`), tables, and checklists (`- [ ]`/`- [x]`). No native underline syntax — that mark is flattened to plain text on export. |
